...
function About() {
	...
	return (
		<div className={"d-flex align-items-center mx-auto"}>
			<div
				className={`bg-dark h-auto vw-sm-70 vw-lg-60 vw-lg-50 vw-xl-40 rounded-3 d-flex flex-column align-items-center shadow-lg px-2 pt-3 pb-1 pt-md-4 ${readMore && "mb-4 mb-md-0"}`}>
				<div className={"w-30 w-md-25 w-lg-20 h-auto pb-3"}>
					<img src={profilePicture} alt={"Me"} className={"img-fluid rounded-circle shadow-sm"}/>
				</div>
				<div className={'text-center lead'}>
					{defaultContent}
					{readMore && extraContent}

					<p className={"text-themed btn"} onClick={() => {
